...
namespace ts
{
  namespace common
  {
    namespace tcp
    {
      ...
      using OnClientAcceptedFunc = std::function<void(ClientPtr client)>;
	 ...
	 * @return
	 */
	boost::asio::ip::tcp::endpoint createEndpointFromAddress(std::string const &host, unsigned short port);
