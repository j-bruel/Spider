...
namespace ts
{
  namespace common
  {
	 ...
	 * @param port
	 */
	void asyncConnect(std::string const &host, unsigned short port, OnConnectFunc onConnect);
	 ...
	 * @param onWrite
	 */
	void asyncWrite(void const *data, size_t size, OnWriteFunc onWrite = nullptr);
